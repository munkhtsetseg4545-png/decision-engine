const QUESTIONS = [
  ...
  { key:"complexity",                text:"6. Би яагаад авч/барьж байгаагаа энгийнээр тайлбарлаж чадах уу?",                                         cat:"Thinking",    lo:"Маш төвөгтэй",        hi:"Энгийн",             hardFail:null, redFlag:4 },
  ...
  { key:"survival",                  text:"10. Хэрэв энэ хөрөнгө оруулалт буруу болбол, би санхүүгийн болон сэтгэлзүйн хувьд дааж, үргэлжлүүлэн тоглож чадах уу?", cat:"Risk", lo:"Survive хийхгүй", hi:"Мэдээж survive", hardFail:3, redFlag:4 },
];
...
function showResult(data) {
  ...
  for (const [key, val] of Object.entries(data.normalized_scores)) {
    ...
    qsHtml += `<div class="qs-item ${isHardFail ? 'qs-hardfail' : ''}"><span class="qs-key">${key.replace(/_/g,' ')}</span><span class="qs-val">${val}/10</span></div>`;
  }
